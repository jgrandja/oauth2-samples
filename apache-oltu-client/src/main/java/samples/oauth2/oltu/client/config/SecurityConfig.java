...
import org.springframework.security.oauth2.client.filter.oltu.OltuAuthorizationResponseHandler;
...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
	...
	public AuthorizationRequestRedirectStrategy authorizationRequestRedirectStrategy(
		...
		OltuAuthorizationRequestRedirectStrategy authorizationRequestRedirectStrategy =
				new OltuAuthorizationRequestRedirectStrategy(clientContextResolver, clientContextRepository);
	...
	public AuthorizationResponseHandler authorizationResponseHandler(
		...
		OltuAuthorizationResponseHandler authorizationResponseHandler =
				new OltuAuthorizationResponseHandler(clientContextResolver, clientContextRepository);
